if (location.hostname.match(/^(?:www\.)?(citigold\.)*citi(bank|corp|group|gold)*\.(com|sg)(\.sg)*/)) {
    var reportSuites = "citiintlsingaporeprod"
} else {
    var reportSuites = "citiintlsingaporedev"
}
omtr_omnitureRSID = reportSuites;
omtr_internalDomain = "javascript:,citibank.com.sg,citigold.com.sg,citi.com.sg";
omtr_countryID = "SG";
omtr_siteID = "Citibank Singapore";
omtr_externalcampaignID = "cid,ecid,media";
omtr_internalcampaignID = "eOfferCode,intcid,icid";
omtr_charSet = "ISO-8859-1";
omtr_timezone = "+8";
omtr_currency = "SGD";
omtr_pagePrefix = "SG";
var s_account = omtr_omnitureRSID;
...
s.siteID = omtr_pagePrefix;
s.defaultPage = "index";
s.queryVarsList = "path,TTC,categoryId,pageID,screenId,actionForm,boxType,tabId";
s.pathExcludeDelim = "";
s.pathConcatDelim = "|";
s.pathExcludeList = "";
s.usePlugins = true;
...
function s_doPlugins(a) {
    a.prop50 = "Citi Intl s_code v2.5 - 20140611 | SiteCatalyst Base Code H25.2";
    ...
    if (a.pageName.indexOf(".html") > -1) {
        a.pageName = a.repl(a.pageName, ".html", "")
    }
    if (a.pageName.indexOf(".htm") > -1) {
        a.pageName = a.repl(a.pageName, ".htm", "")
    }
    if (a.pageName.indexOf("SG|SGGCB|") > -1) {
        a.pageName = a.repl(a.pageName, "SG|SGGCB|", "SGGCB|")
    }
    if (!a.channel) {
    ...
    a.prop12 = omtr_siteID;
    a.tempSearchPage = a.getPreviousValue(a.pageName, "s_gpv_pageName", "");
    a.prop20 = a.tempSearchPage;
    if (typeof queryprop19 != "undefined" && queryprop19) {
        a.prop19 = queryprop19
    }
    if (a.prop19) {
        a.prop19 = a.getValOnce(a.prop19, "s_gvo_c19", 0)
    }
    if (a.prop19) {
        a.eVar14 = a.prop19 = a.prop19.toLowerCase();
        a.events = a.apl(a.events, "event1", ",", 2)
    }
    a.tempIntCampaign = a.getQueryParam(omtr_internalcampaignID);
    if ((a.tempIntCampaign.indexOf("CIDSG") > -1) && (!a.campaign)) {
        a.campaign = a.tempIntCampaign
    } else {
        a.eVar2 = a.tempIntCampaign
    }
    a.eVar2 = a.getValOnce(a.eVar2, "s_gvo_v2", 0);
    if (a.eVar2) {
        a.events = a.apl(a.events, "event15", ",", 2)
    }
    if (!a.eVar18 && a.eVar18 != "EQTAlert") {
        a.eVar18 = a.getQueryParam("plink")
    }
    a.eVar18 = a.getValOnce(a.eVar18, "s_gvo_v18", 0);
    if (a.products) {
    ...
    a.eVar49 = a.prop49 = a.wd.location;
    a.prop17 = a.eVar11 = a.getNewRepeat();
    a.prop18 = a.eVar13 = a.getVisitNum();
    if (typeof customerId != "undefined" && customerId) {
        a.prop5 = customerId
    }
    a.prop5 = a.getAndPersistValue(a.prop5, "s_pers_c5", 1825);
    if (!a.prop5) {
        a.prop5 = "anon"
    }
	...
	/* Plugin Example: setupLinkTrack 2.0.3 */
 
    s.hbx_lt = "auto" // manual, auto
    s.setupLinkTrack("prop32,prop33,prop34,prop35","SC_LINKS");
    ...
    a.tempProducts = a.getPreviousValue(a.products, "s_gpv_products", "");
    if ((a.events && (a.events + ",").indexOf("event7,") > -1) && !a.products) {
        a.products = a.tempProducts
    }
    if (!a.eVar47) {
        a.eVar47 = a.getQueryParam("lid");
        a.eVar47 = a.getValOnce(a.eVar47, "s_gvo_v47", 0);
        if (a.eVar47) {
            a.events = a.apl(a.events, "event16", ",", 2)
        }
    }
}
